...
I built, trained, and evaluated deep learning models (including **Deep Residual U‑Net**) as part of a collaborative project with **Omdena** and **Spacept**. [Omdena](https://cms.omdena.com/projects/ai-prevent-forest-fires)
